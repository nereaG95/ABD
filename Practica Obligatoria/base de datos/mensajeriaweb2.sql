...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2017 a las 23:56:22
...
INSERT INTO `mensajes` (`idMensaje`, `mensaje`, `tipo`, `emisor`, `receptor`, `fecha`, `grupo`) VALUES
(45, 'hola', 'comun', 'Admin', NULL, '2017-05-31 21:55:58', NULL);
...
--
-- Volcado de datos para la tabla `tipomusicausuarios`
--

INSERT INTO `tipomusicausuarios` (`idUser`, `tipoMusica`) VALUES
('Admin', 'Rock and roll'),
('Nerea', 'Rock and roll'),
('Nerea', 'Pop');
...
INSERT INTO `usuarios` (`idUser`, `password`, `edad`, `esAdmin`) VALUES
('Admin', '$2y$10$z3LCq/C9B30UdxmuwaUsm.Y.tSPzv4/IuGPjK3fdOfXnd0WybVYBi', 22, 1),
('Nerea', '$2y$10$injHPnjqvS2X/F9nDRizLu0UKB/dldLx.bPKlCND1utkFseoyuXKu', 22, 0);
...
--
ALTER TABLE `mensajes`
  MODIFY `idMensaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
